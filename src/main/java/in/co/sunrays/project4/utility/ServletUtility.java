...
import in.co.sunrays.project4.model.AppRole;
...
public class ServletUtility {
	...
	public static void forwardView(String page, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
