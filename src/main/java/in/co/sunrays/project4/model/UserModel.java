...
import in.co.sunrays.project4.utility.EmailBuilder;
import in.co.sunrays.project4.utility.EmailMessage;
import in.co.sunrays.project4.utility.EmailUtility;


import in.co.sunrays.project4.utility.JDBCDataSource;
	   ...
	   public Integer nextPK() throws DatabaseException {
        ...
        log.debug("Model update End");
	        ...
	        public UserBean authenticate(String login, String password) throws ApplicationException {
	            log.debug("User Model authenticate Started");
        ...
        return flag;
	        ...
	        public boolean changePassword(Long id, String oldPassword,
	                String newPassword) throws RecordNotFoundException, ApplicationException {
	            ...
	            msg.setSubject("Asteroid Systems Password has been changed Successfully.");
        ...
        msg.setSubject("Registration is successful for Asteroid");
        msg.setMessage(message);
        msg.setMessageType(EmailMessage.HTML_MSG);
        ...
        EmailMessage msg = new EmailMessage();
        msg.setTo(login);
        msg.setSubject("Asteroid Password reset");
        msg.setMessage(message);
        msg.setMessageType(EmailMessage.HTML_MSG);
        EmailUtility.sendMail(msg);
        flag = true;
